...
[문제 링크](https://leetcode.com/problems/cut-off-trees-for-golf-event/description/) 
...
### 문제 설명
<div class="HTMLContent_html__0OZLp" data-track-load="description_content"><p>You are asked to cut off all the trees in a forest for a golf event. The forest is represented as an <code>m x n</code> matrix. In this matrix:</p>
...
먼저 방문해야 하는 나무의 순서를 파악한 뒤</br>
맞는 순서로 방문하는 경우만 처리하도록 BFS를 구현하면 된다</br>