...
## ⏱ 성능
- 시간: 6796ms(다 때려박기), 4888ms(DFS)
- 메모리: 38456KB, 40168KB(DFS)
---

## 💡 풀이 핵심

그냥 회전, 대칭 경우의 수 다 때려넣고 하는 방법이랑</br>
ㅗ 모양만 위와 똑같이 하고, 나머지는 DFS로 돌리는 방법이 있다.</br>
DFS로 하면 ㅗ 모양을 제외한 모든 경우의 수를 전부 탐색한다.
