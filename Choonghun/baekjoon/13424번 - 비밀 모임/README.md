# 13424번: 비밀 모임 - <img src="https://static.solved.ac/tier_small/12.svg" style="height:20px" /> Gold IV
...
친구들이 속한 방에서 다익스트라를 쓰거나
플로이드 워셜로 모든 방에 대해서 최단 거리를 구해서
이동 거리의 총합이 가장 작은 방을 고르면 되는 문제