...
<div class="guide-section" style="width: calc(89.7283% - 12px);">
      <div class="tab-pane fade active show" id="tour2">
        <div class="guide-section-description">
          <h6 class="guide-section-title">
            문제 설명
          </h6>
          <div class="markdown solarized-dark"><p>각 점에 가중치가 부여된 트리가 주어집니다. 당신은 다음 연산을 통하여, 이 트리의 모든 점들의 가중치를 0으로 만들고자 합니다.</p>
...
아무 노드 하나를 루트로 잡고 DFS로 리프노드까지 도달한 다음에</br>
재귀로 a[cur]을 모두 합산하면 된다. </br>
합산한 다음에 자식 노드의 절대값 만큼 answer에 더하고,</br>
자식 노드는 0으로 초기화 해주어야 한다.