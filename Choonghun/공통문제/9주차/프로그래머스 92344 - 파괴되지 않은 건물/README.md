...
<pre class="console-content"><div></div><div class="console-heading">채점을 시작합니다.</div><div class="console-message">정확성  테스트</div><table class="console-test-group" data-category="correctness"><tbody><tr data-testcase-id="109587"><td valign="top" class="td-label">테스트 1 <span>〉</span></td><td class="result passed">통과 (0.01ms, 11.4MB)</td></tr><tr data-testcase-id="109588"><td valign="top" class="td-label">테스트 2 <span>〉</span></td><td class="result passed">통과 (0.03ms, 11.6MB)</td></tr><tr data-testcase-id="109589"><td valign="top" class="td-label">테스트 3 <span>〉</span></td><td class="result passed">통과 (0.08ms, 11.5MB)</td></tr><tr data-testcase-id="109590"><td valign="top" class="td-label">테스트 4 <span>〉</span></td><td class="result passed">통과 (0.21ms, 11.4MB)</td></tr><tr data-testcase-id="109591"><td valign="top" class="td-label">테스트 5 <span>〉</span></td><td class="result passed">통과 (0.26ms, 11.4MB)</td></tr><tr data-testcase-id="109592"><td valign="top" class="td-label">테스트 6 <span>〉</span></td><td class="result passed">통과 (0.38ms, 11.7MB)</td></tr><tr data-testcase-id="109593"><td valign="top" class="td-label">테스트 7 <span>〉</span></td><td class="result passed">통과 (0.54ms, 11.7MB)</td></tr><tr data-testcase-id="109594"><td valign="top" class="td-label">테스트 8 <span>〉</span></td><td class="result passed">통과 (0.67ms, 11.7MB)</td></tr><tr data-testcase-id="109595"><td valign="top" class="td-label">테스트 9 <span>〉</span></td><td class="result passed">통과 (0.89ms, 11.6MB)</td></tr><tr data-testcase-id="109596"><td valign="top" class="td-label">테스트 10 <span>〉</span></td><td class="result passed">통과 (1.41ms, 11.7MB)</td></tr></tbody></table><div class="console-message">효율성  테스트</div><table class="console-test-group" data-category="effectiveness"><tbody><tr data-testcase-id="109597"><td valign="top" class="td-label">테스트 1 <span>〉</span></td><td class="result passed">통과 (454.15ms, 136MB)</td></tr><tr data-testcase-id="109598"><td valign="top" class="td-label">테스트 2 <span>〉</span></td><td class="result passed">통과 (441.49ms, 136MB)</td></tr><tr data-testcase-id="109599"><td valign="top" class="td-label">테스트 3 <span>〉</span></td><td class="result passed">통과 (473.69ms, 136MB)</td></tr><tr data-testcase-id="109600"><td valign="top" class="td-label">테스트 4 <span>〉</span></td><td class="result passed">통과 (453.49ms, 136MB)</td></tr><tr data-testcase-id="109601"><td valign="top" class="td-label">테스트 5 <span>〉</span></td><td class="result passed">통과 (245.38ms, 102MB)</td></tr><tr data-testcase-id="109602"><td valign="top" class="td-label">테스트 6 <span>〉</span></td><td class="result passed">통과 (228.63ms, 102MB)</td></tr><tr data-testcase-id="109603"><td valign="top" class="td-label">테스트 7 <span>〉</span></td><td class="result passed">통과 (257.88ms, 102MB)</td></tr></tbody></table><div class="console-heading">채점 결과</div><div class="console-message">정확성: 53.8</div><div class="console-message">효율성: 46.2</div><div class="console-message">합계: 100.0 / 100.0</div></pre>

### 제출 일자

2026년 06월 02일 01:37:01
...
차분 배열을 이용하여 풀되, 시간 초과를 고려해야 하는 문제이다.</br>
각 Row별로 +d, -d를 하면 시간 초과가 발생하며</br>
r1의 c1, c2+1 에 대해서 +d, -d</br>
r2+1의 c1, c2+1 에 대해서 -d, +d</br>
데미지를 입는 경우는 그 반대로 해준 다음</br>
Row -> Column 순서로 한 번 복구</br>
Column -> Row 순서로 한 번 복구</br>
해준 다음 Board의 값들과 합쳐서 1 이상인 값의 개수만 더하여 반환하면 된다.
